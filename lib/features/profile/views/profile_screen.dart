...
import 'package:najiz_go_express/features/profile/widgets/delete_account_dialog.dart';
import 'package:najiz_go_express/features/profile/widgets/profile_identity_summary.dart';
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (!isGuest) ProfileIdentitySummary(profile: profile),
                          ...
                          children: [
                            Expanded(
                              child: OutlinedButton(
                                onPressed: AppRoutes.openSignup,
                ...
                _ActionCard(
                  ...
                  onTap: () => AppRoutes.openProfileAddressEditor(
                ...
                _ActionCard(
                  ...
                  onTap: () => AppRoutes.openSearch(token: token),
                ),
                const SizedBox(height: 10),
                _ActionCard(
                ...
                _ActionCard(
                  ...
                  onTap: () {
                    ...
                    AppRoutes.openReferralCoupon(token: currentToken);
                  },
                ),
                const SizedBox(height: 10),
                _ActionCard(
                ...
                _ActionCard(
                  ...
                  onTap: () {
                    ...
                    AppRoutes.openSupportChat(token: currentToken);
                  },
                ),
