...
class _MyOrdersScreenState extends State<MyOrdersScreen> {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(MyOrdersController(), tag: 'my-orders', permanent: true);
                        ...
                        : _ActiveOrderCard(
                            ...
                            onCancel: () async {
                              ...
                              try {
                                ...
                                final restricted =
                                    await resolveOrderCancellationLimitService()
                                        .onOrderCancelledSuccessfully(context);
                                if (restricted || !context.mounted) return;
                                AppSnackbar.show(
                                  'orders.success'.tr,
...
bool _isVendorDeliveryOrder(String type) {
